...
void radixSort(int *arr, int begin, int end, int digit) {
	...
	int* bucket = (int*)malloc(sizeof(int)* (end - begin + 1));
...
//https://github.com/hubwiz/sort-algorithm/blob/master/sort.cpp
int main() {
	{
		printf("=============bucketSort===================\n");
		int arr[] = { 85, 63, 1, 4, 64, 96, 56 };
		print(arr, arrLen(arr));
		bucketSort(arr, arrLen(arr));
		print(arr, arrLen(arr));
	}
	{
		printf("=============heapSort===================\n");
